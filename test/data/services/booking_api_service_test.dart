...
import 'package:khelam/data/services/booking_api_service.dart';
...
void main() {
  group('BookingApiService', () {
    // Slot payloads as returned by GET /slots (see
    // lib/ui/features/schedule/data/dummy.dart for the shape).
    ...
    test('getSchedule sends turfId and yyyy-MM-dd date query parameters',
        () async {
      final _RecordingAdapter adapter = _RecordingAdapter(
      ...
      expect(request.queryParameters['turfId'], '44444444-4444-4444-4444-444444444441');
