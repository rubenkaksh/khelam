...
- **[T4] Analytics — DESCOPED (user 2026-08-07)** — no analytics seam, no event triggers, until analytics is actually planned. Revisit pre-launch. (Samseer is a dev network inspector, not analytics.)
- **[T6] Perf/rebuild hygiene + Samseer-in-prod gate — DESCOPED (user 2026-08-07)** — bundled with T4 out-of-scope. Re-add when needed.
